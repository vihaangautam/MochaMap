const apiKey = AIzaSyDu1kO_X32xuvMXAm4hnqcOzR-VUkXkV-U; // Replace with your real API key!
const useProxy = true;
...
function displayCards(cafes) {
  ...
  cafes.forEach((cafe, i) => {
    ...
    const imgUrl = cafe.photos?.photo_reference
      ? `https://maps.googleapis.com/maps/api/place/photo?maxwidth=400&photoreference=${cafe.photos.photo_reference}&key=${apiKey}`
